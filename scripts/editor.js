...
function canvasDriver() {
    console.log("Running Canvas Driver. . .");
...
function runEditor({
    ...
    // ace.config.set('basePath', chrome.runtime.getURL('src-min'));
    ace.config.set('basePath', chrome.runtime.getURL('/src-min'));
    ace.config.set('modePath', chrome.runtime.getURL('/src-min'));
    ace.config.set('themePath', chrome.runtime.getURL('/src-min'));
